...
</nav><div class="content"><div id="right-panel-background"></div><div class="middle"><header><h1 id="top">Roodito API</h1></header></div><div class="right"><h5>API Endpoint</h5><a href="#">roodito.com</a></div><div class="middle"><p>Welcome to Roodito mobile API, here you will find all the information related to the endpoints available.</p>
